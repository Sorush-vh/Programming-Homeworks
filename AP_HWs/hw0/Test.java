...
public class HolaEinstein extends Application {
    ...
    public static void main(String[] args) {
        Application.launch(args);//  w  w   w   .  d  e m o   2  s   .c    o m 
    }

    @Override
    public void start(Stage stage) {
        String message = "Bienvenidos al mundo de JavaFx " + "donde podreis tomaros un cafe "
                + "mientras aprendeis este nuevo " + "tipo de programacion "
